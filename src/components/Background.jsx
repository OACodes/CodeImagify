...
const Background = ({ updateBackground }) => {
    ...
    // const [bg, setbg] = useState('#2196F3');
    ...
    return (
        <div className={'flex flex-col w-fit'}>
            <button type="button" onClick={toggle} className={"inline-flex items-center justify-center text-sm border border-[#e4e4e7] h-10 px-4 py-2 w-30 mb-0.5"}>
